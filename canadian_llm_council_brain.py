...
async def run_stage1_sonnet(
    ...
    start = time.time()
    stage_tokens = {"model": "claude-sonnet-4-6-20250514", "input_tokens": 0, "output_tokens": 0}
...
async def run_stage3_opus(
    ...
    start = time.time()
    stage_tokens = {"model": "claude-opus-4-6-20250514", "input_tokens": 0, "output_tokens": 0}
...
async def run_stage4_grok(
    ...
    if not use_grok:
        ...
        stage_tokens["model"] = "claude-opus-4-6-20250514"
        stage_tokens["input_tokens"] += _usage.get("input_tokens", 0)
        stage_tokens["output_tokens"] += _usage.get("output_tokens", 0)
